...
public class URIConstant {
    ...
    public static  final String LOCATION_COUNTRY_FILTER = "/positions";

    public static  final String COUNTRY_CAPITAL_FILTER = "/capital";

    public static  final String COUNTRY_CURRENCY_FILTER = "/currency";
